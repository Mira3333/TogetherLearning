...
<head>
  ...
  <title>Together Learning - Test Result</title>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-md-12 d-flex align-items-stretch">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">測驗結果</h5>
                <h5 class="testResult">${ testRecord.testGrade }分</h5>
                <table class="card-table">
                    <tr class="row-title">
                      <td class="question-title">題目</td>
                      <td class="yourans-title">您的作答</td>
                      <td class="ans-title">答案</td>
                    </tr> 
                              
                 <c:forEach  items="${qaList}"  var="qaMap">  <!-- qaList裡面是放qaMap，要取qaMap需要透過key來取value -->
                    <tr class="row-details">
                      <td class="question">${qaMap.dataQuestion.question}</td> 
                      <td>${qaMap.studentAnswer}</td>
                      <td>${qaMap.dataQuestion.answer}</td>
                    </tr>
                 </c:forEach>
