  ...
  <main id="main" data-aos="fade-in">
    ...
    <section id="courses" class="courses">
      <div class="container" data-aos="fade-up">
		...
		<c:forEach  items="${testSubjectList}"  var="testSubject">  
              ...
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
			     <table class="test-table">
					<tr class="test-titleline">
					  <td class="test-title">
						<p class="testTitle">${testSubject.testSubject}</p>
						<input type="hidden" value = "${ testSubject.testSubjectId }" name="testSubjectId">
					  </td>
					</tr>
					
				 <c:forEach  items="${testSubject.tests}"  var="tests">
					<tr class="test-name">					
					  <td>
						<form action="/test-entery" method="post">
							<input type="submit" value = "${tests.testName}" class="testList">
							<input type="hidden" value = "${tests.testId}" class="testList" name="testId">
						</form>
					  </td>
					</tr>
				 </c:forEach>
